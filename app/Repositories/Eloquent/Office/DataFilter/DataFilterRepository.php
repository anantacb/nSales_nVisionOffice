...
namespace App\Repositories\Eloquent\Office\DataFilter;

use App\Models\Office\DataFilter;
use App\Repositories\Eloquent\Base\BaseRepository;

class DataFilterRepository extends BaseRepository implements DataFilterRepositoryInterface
{
    public function __construct(DataFilter $model)
    {
