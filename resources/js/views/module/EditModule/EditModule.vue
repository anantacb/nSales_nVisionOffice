                        ...
                        <div class="row space-y-2">
                            ...
                            <div class="col-lg-12 space-y-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <Select id="MenuVisible" v-model="ModuleModel.MenuVisible"
                                                :options="booleanOptions"
                                                :required="true"
                ...
                <BaseBlock>
                    <template #content>
                        <ul class="nav nav-tabs nav-tabs-block" role="tablist">
                            ...
                            <li v-if="!['Root', 'Core', 'Package'].includes(ModuleModel.Type)" class="nav-item">
                                <button id="companies-tab"
                        ...
                        <div class="block-content tab-content">
                            <div id="applications"
                                 ...
                                 role="tabpanel"
                                 tabindex="0">
                                <ApplicationsTable :applications="ModuleModel.applications"></ApplicationsTable>
                            </div>
                            <div v-if="!['Root', 'Core', 'Package'].includes(ModuleModel.Type)" id="companies"
