...
function deleteLanguage(language, index) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            let {data, message} = await Language.delete(language.Id);
