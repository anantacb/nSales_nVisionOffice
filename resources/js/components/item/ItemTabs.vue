...
import TabDetails from "@/components/item/TabDetails.vue";
import TabAttributes from "@/components/item/TabAttributes.vue";
import TabTranslations from "@/components/item/TabTranslations.vue";
import CompanyLanguage from "@/models/Company/CompanyLanguage";
import TabSeo from "@/components/item/TabSeo.vue";
