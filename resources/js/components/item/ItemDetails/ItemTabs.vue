...
import TabDetails from "@/components/item/ItemDetails/TabDetails.vue";
import TabAttributes from "@/components/item/ItemDetails/TabAttributes.vue";
import TabTranslations from "@/components/item/ItemDetails/TabTranslations.vue";
import CompanyLanguage from "@/models/Company/CompanyLanguage";
import TabSeo from "@/components/item/ItemDetails/TabSeo.vue";
